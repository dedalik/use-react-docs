...
const overviewMap = {
  ...
  useEventListener: {
    ...
    accepts: ["`eventName`: event to listen for.", "`listener`: event handler.", "`target` (optional): event target or ref."],
  ...
  useIntersectionObserver: {
    ...
    accepts: ["`elementRef`: target element ref.", "`options` (optional): standard intersection observer options plus `freezeOnceVisible`."],
  ...
  useLocalStorage: {
    ...
    accepts: ["`key`: storage key.", "`initialValue`: initial state or lazy initializer function.", "`options` (optional): serializer, deserializer, and storage behavior flags."],
  ...
  useMediaQuery: {
    ...
    accepts: ["`query`: CSS media query string.", "`options` (optional): default value, initialization mode, and custom target window."],
  ...
  useMutationObserver: {
    ...
    accepts: ["`elementRef`: node ref to observe.", "`callback`: mutation handler.", "`options` (optional): observer configuration."],
    returns: ["This hook returns nothing."],
  },
  useOnMount: {
  ...
  useSessionStorage: {
    ...
    accepts: ["`key`: storage key.", "`initialValue`: initial state or lazy initializer.", "`options` (optional): serializer and deserializer config."],
  ...
  useTimeout: {
    ...
    accepts: ["`callback`: function to run after delay.", "`delay`: timeout in milliseconds (`null` disables timeout)."],
    returns: ["This hook returns nothing."],
  },
  useTitle: {
    ...
    accepts: ["`title`: new page title.", "`restoreOnUnmount` (optional): restore previous title when component unmounts."],
    returns: ["This hook returns nothing."],
  },
  useToggle: {
