...
const guideDescriptions = {
  ...
  "components.md":
    "Vue components embedded in the useReact VitePress docs: function filters and interactive listings.",
  "contributing.md":
    "Contribute to @dedalik/use-react and docs: hook catalog, tests, ssr-support.json, and focused pull requests.",
  "guidelines.md":
    "Documentation and API guidelines for @dedalik/use-react hooks published on usereact.org.",
}
